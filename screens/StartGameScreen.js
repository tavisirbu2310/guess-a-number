    ...
    if (confirmed) {
        confirmedOutput = (
            <Card style={styles.summaryContainer}>
                ...
                <MainButton type='main' onPress={() => props.onStartGame(selectedNumber)}>START GAME</MainButton>
            </Card>
        );
    }
                ...
                <TouchableWithoutFeedback onPress={() => {
                    ...
                    <View style={styles.screen}>
                        ...
                        <Card style={styles.inputContainer}>
                            ...
                            <Input
                                style={styles.input} blurOnSubmit autoCapitalize='none' autoCorrect={false}
